...
public class Graph2Controller implements Initializable {
    ...
    @FXML
    private ListView<String> listViewGraph2;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        listViewGraph2.getSelectionModel().setSelectionMode(SelectionMode.MULTIPLE);
        ...
        for (Country gm:covidData)
        {
            ...
            if(countryCode1.equals(gm.getCountryTerritoryCode()) && boolCountry )
            {
                ...
                listViewGraph2.getItems().add(gm.getCountriesAndTerritories());
    ...
    public void Show() {
        ...
        countryInfo = listViewGraph2.getSelectionModel().getSelectedItems();
            ...
            for (String s:countryInfo)
            {
                for (Graph2Model model : models)
                {
                    ...
                    if (s.equals(model.getCountry()))
                    {
                        ...
                        totalcase +=Integer.parseInt(model.getCases());
                        ...
                        {
                            series.getData().add(new XYChart.Data<String, Number>(model.getDates(),totalcase));
                        }
    ...
    public void GetData(ArrayList<Country> covid19s) {
        covidData = covid19s;
        models = SortAndWrite();
